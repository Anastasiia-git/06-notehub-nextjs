...
"[project]/Desktop/projects/react-0.2/06-notehub-nextjs/app/notes/loading.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/Desktop/projects/react-0.2/06-notehub-nextjs/app/notes/loading.tsx [app-rsc] (ecmascript)"));
}),
...
const getSingleNote = async (id)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$react$2d$0$2e$2$2f$06$2d$notehub$2d$nextjs$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`/notes/${id}`);
    return res.data;
};
}),
...
const NoteDetails = async ({ params })=>{
    ...
    const note = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$react$2d$0$2e$2$2f$06$2d$notehub$2d$nextjs$2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSingleNote"])(id);
    console.log(note);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7f023df9._.js.map